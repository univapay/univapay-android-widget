...
class ProgressWheel : View {
    ...
    constructor(context: Context, attrs: AttributeSet) : super(context, attrs) {
        ...
        parseAttributes(context.obtainStyledAttributes(attrs, com.univapay.R.styleable.ProgressWheel))
    ...
    private fun parseAttributes(a: TypedArray) {
        ...
        circleRadius = a.getDimension(com.univapay.R.styleable.ProgressWheel_matProg_circleRadius, circleRadius.toFloat()).toInt()

        fillRadius = a.getBoolean(com.univapay.R.styleable.ProgressWheel_matProg_fillRadius, false)

        barWidth = a.getDimension(com.univapay.R.styleable.ProgressWheel_matProg_barWidth, barWidth.toFloat()).toInt()

        rimWidth = a.getDimension(com.univapay.R.styleable.ProgressWheel_matProg_rimWidth, rimWidth.toFloat()).toInt()

        val baseSpinSpeed = a.getFloat(com.univapay.R.styleable.ProgressWheel_matProg_spinSpeed, spinSpeed / 360.0f)
        spinSpeed = baseSpinSpeed * 360

        barSpinCycleTime = a.getInt(com.univapay.R.styleable.ProgressWheel_matProg_barSpinCycleTime, barSpinCycleTime.toInt()).toDouble()

        barColor = a.getColor(com.univapay.R.styleable.ProgressWheel_matProg_barColor, barColor)

        rimColor = a.getColor(com.univapay.R.styleable.ProgressWheel_matProg_rimColor, rimColor)

        linearProgress = a.getBoolean(com.univapay.R.styleable.ProgressWheel_matProg_linearProgress, false)

        if (a.getBoolean(com.univapay.R.styleable.ProgressWheel_matProg_progressIndeterminate, false)) {
            spin()
        }
